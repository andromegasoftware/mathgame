...
public class carpma_orta extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_carpma_orta);
                    ...
                    if(hata <= 0) {
                        h.postDelayed(new Runnable() {
                            ...
                            public void run() {
                                ...
                                Intent i = new Intent(carpma_orta.this, Sonuc.class);
    ...
    public void oyunDevam()
    {
        ...
        sayi1 = random.nextInt(10)+3;
        sayi2 = random.nextInt(10)+3;
        ...
        soru.setText((sayi1 + " x " + sayi2).toString());
    ...
    public void onBackPressed() {
        AlertDialog.Builder alert = new AlertDialog.Builder(carpma_orta.this);
        ...
        alert.setPositiveButton(R.string.evet, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                Intent in = new Intent(carpma_orta.this, giris.class);
                finish();
                startActivity(in);
            }
        });
