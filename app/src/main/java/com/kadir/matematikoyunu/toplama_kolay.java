...
public class toplama_kolay extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_toplama_kolay);
                        ...
                        if(hata <= 0) {
                            h.postDelayed(new Runnable() {
                                ...
                                public void run() {
                                    ...
                                    Intent i = new Intent(toplama_kolay.this, Sonuc.class);
    ...
    public void onBackPressed() {
        AlertDialog.Builder alert = new AlertDialog.Builder(toplama_kolay.this);
        ...
        alert.setPositiveButton(R.string.evet, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                Intent in = new Intent(toplama_kolay.this, giris.class);
                finish();
                startActivity(in);
            }
        });
