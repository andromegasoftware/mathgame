...
public class zihin_oyunu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_zihin_oyunu);
                    ...
                    if(hata <= 0) {
                        h.postDelayed(new Runnable() {
                            ...
                            public void run() {
                                ...
                                Intent i = new Intent(zihin_oyunu.this, Sonuc.class);
    ...
    public void oyunDevam()
    {
        ...
        cevap_a.setVisibility(View.INVISIBLE);
        cevap_b.setVisibility(View.INVISIBLE);
        cevap_c.setVisibility(View.INVISIBLE);
        cevap_d.setVisibility(View.INVISIBLE);
        ...
        sayi1 = random.nextInt(20);
        sayi2 = random.nextInt(15);
        double sayi3a = -5 + (Math.random() * (10 - (-10)));
        sayi3 = ((int) sayi3a);
        sayi4 = random.nextInt(10);
        double sayi5a = -5 + (Math.random() * (10 - (-10)));
        sayi5 = ((int) sayi5a);


        yanlis_cevap = random.nextInt(15) + 1;
        ...
        yanlis_sik_3 = sonuc + yanlis_cevap + 5;



        soru = (Button) findViewById(R.id.btn_soru);

        soru.setText(("+" + sayi1).toString());
        dogru.start();

        h.postDelayed(new Runnable() {
            @Override
            public void run() {
                soru.setText(("+" + sayi2).toString());
                dogru.start();
            }
        }, 2000);
        ...
        h.postDelayed(new Runnable() {
            @Override
            public void run() {
                cevap_a.setVisibility(View.VISIBLE);
                cevap_b.setVisibility(View.VISIBLE);
                cevap_c.setVisibility(View.VISIBLE);
                cevap_d.setVisibility(View.VISIBLE);
    ...
    public void onBackPressed() {
        AlertDialog.Builder alert = new AlertDialog.Builder(zihin_oyunu.this);
        ...
        alert.setPositiveButton(R.string.evet, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                Intent in = new Intent(zihin_oyunu.this, giris.class);
                finish();
                startActivity(in);
            }
        });
