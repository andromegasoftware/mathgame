...
public class karisik_kolay extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_karisik_kolay);
                    ...
                    if(hata <= 0) {
                        h.postDelayed(new Runnable() {
                            ...
                            public void run() {
                                ...
                                Intent i = new Intent(karisik_kolay.this, Sonuc.class);
    ...
    public void oyunDevam()
    {
        ...
        switch (karisik_islem_secimi)
        {
            ...
            case 2:
                ...
                break;
            case 3:{
                sayi1 = random.nextInt(5);
                sayi2 = random.nextInt(5);
                sonuc = sayi1 * sayi2;}
                break;

            case 4: {
                sayi2 = random.nextInt(3) + 1;
                sayi1 = (random.nextInt(5) + 1) * sayi2;
                sonuc = sayi1 / sayi2;
            } break;
        }
    ...
    public void onBackPressed() {
        AlertDialog.Builder alert = new AlertDialog.Builder(karisik_kolay.this);
        ...
        alert.setPositiveButton(R.string.evet, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                Intent in = new Intent(karisik_kolay.this, giris.class);
                finish();
                startActivity(in);
            }
        });
