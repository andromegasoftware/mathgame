...
public class bolme_orta extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bolme_orta);
                    ...
                    if(hata <= 0) {
                        h.postDelayed(new Runnable() {
                            ...
                            public void run() {
                                ...
                                Intent i = new Intent(bolme_orta.this, Sonuc.class);
    ...
    public void oyunDevam()
    {
        ...
        sayi2 = random.nextInt(5 )+1;
        sayi1 = (random.nextInt(7 )+5)*sayi2;
    ...
    public void onBackPressed() {
        AlertDialog.Builder alert = new AlertDialog.Builder(bolme_orta.this);
        ...
        alert.setPositiveButton(R.string.evet, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                Intent in = new Intent(bolme_orta.this, giris.class);
                finish();
                startActivity(in);
            }
        });
