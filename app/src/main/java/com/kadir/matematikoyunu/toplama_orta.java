...
public class toplama_orta extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_toplama_orta);
                    ...
                    if(hata <= 0) {
                        h.postDelayed(new Runnable() {
                            ...
                            public void run() {
                                ...
                                Intent i = new Intent(toplama_orta.this, Sonuc.class);
    ...
    public void onBackPressed() {
        AlertDialog.Builder alert = new AlertDialog.Builder(toplama_orta.this);
        ...
        alert.setPositiveButton(R.string.evet, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                Intent in = new Intent(toplama_orta.this, giris.class);
                finish();
                startActivity(in);
            }
        });
