...
public class karisik_orta extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_karisik_orta);
                    ...
                    if(hata <= 0) {
                        h.postDelayed(new Runnable() {
                            ...
                            public void run() {
                                ...
                                Intent i = new Intent(karisik_orta.this, Sonuc.class);
    ...
    public void oyunDevam()
    {
        ...
        sayi1 = random.nextInt(25)+25;
        sayi2 = random.nextInt(25)+25;
        ...
        switch (karisik_islem_secimi)
        {
            ...
            case 2:
                ...
                break;
            case 3: {
                sayi1 = random.nextInt(10)+5;
                sayi2 = random.nextInt(10)+5;
                sonuc = sayi1 * sayi2;}
                break;

            case 4: {
                sayi2 = random.nextInt(5) + 3;
                sayi1 = (random.nextInt(9) + 3) * sayi2;
                sonuc = sayi1 / sayi2;
            } break;
        }
    ...
    public void onBackPressed() {
        AlertDialog.Builder alert = new AlertDialog.Builder(karisik_orta.this);
        ...
        alert.setPositiveButton(R.string.evet, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                Intent in = new Intent(karisik_orta.this, giris.class);
                finish();
                startActivity(in);
            }
        });
