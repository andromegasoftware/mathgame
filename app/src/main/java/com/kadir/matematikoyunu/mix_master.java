...
public class mix_master extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mix_master);
                    ...
                    if(hata <= 0) {
                        h.postDelayed(new Runnable() {
                            ...
                            public void run() {
                                ...
                                Intent i = new Intent(mix_master.this, Sonuc.class);
    ...
    public void oyunDevam()
    {
       ...
       double sayia = -100 + (Math.random() * (100-(-100)));
       sayi1= ((int) sayia);
        System.out.println(sayi1);
        double sayib = -100 + (Math.random() * (100-(-100)));
        sayi2= ((int) sayib);
        ...
        switch (karisik_islem_secimi)
        {
            ...
            case 2:
                ...
                break;
            case 3: {
                double sayic = -15 + (Math.random() * (15-(-15)));
                sayi1= ((int) sayic);
                System.out.println(sayi1);
                double sayid = -10 + (Math.random() * (10-(-10)));
                sayi2= ((int) sayid);
                System.out.println(sayi2);
                sonuc = sayi1 * sayi2;}
            break;
    ...
    public void onBackPressed() {
        AlertDialog.Builder alert = new AlertDialog.Builder(mix_master.this);
        ...
        alert.setPositiveButton(R.string.evet, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                Intent in = new Intent(mix_master.this, giris.class);
                finish();
                startActivity(in);
            }
        });
