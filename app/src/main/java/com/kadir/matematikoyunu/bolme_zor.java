...
public class bolme_zor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bolme_zor);
                    ...
                    if(hata <= 0) {
                        h.postDelayed(new Runnable() {
                            ...
                            public void run() {
                                ...
                                Intent i = new Intent(bolme_zor.this, Sonuc.class);
    ...
    public void onBackPressed() {
        AlertDialog.Builder alert = new AlertDialog.Builder(bolme_zor.this);
        ...
        alert.setPositiveButton(R.string.evet, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                Intent in = new Intent(bolme_zor.this, giris.class);
                finish();
                startActivity(in);
            }
        });
